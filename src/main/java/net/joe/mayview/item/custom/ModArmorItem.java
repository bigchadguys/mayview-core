...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.HONEY_DIAMOND,
                            List.of(new MobEffectInstance(MobEffects.REGENERATION, 40, 0, false, false)))
                    .put(ModArmorMaterials.SPECTRITE,
                            List.of(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1, false, false)))
                    .put(ModArmorMaterials.ECOLITE,
                            List.of(new MobEffectInstance(MobEffects.REGENERATION, 40, 1, false, false)))
                    .put(ModArmorMaterials.TECTRITE,
                            List.of(new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1, false, false)))
                    .put(ModArmorMaterials.HYDRITE,
