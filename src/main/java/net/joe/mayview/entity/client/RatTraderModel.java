...
public class RatTraderModel extends HierarchicalModel<RatTraderEntity> {
    private final ModelPart mouserat;
    private final ModelPart head;


    public RatTraderModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offset(0.0F, 6.5F, -2.5F));
        ...
        PartDefinition floatie = body.addOrReplaceChild("floatie", CubeListBuilder.create().texOffs(0, 54).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, -1.0F));

        PartDefinition head = mouserat.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 15).addBox(-3.0F, -3.9893F, -4.8F, 6.0F, 5.0F, 7.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition left_leg = mouserat.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(32, 27).addBox(-1.75F, 5.1502F, -6.1244F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(4.25F, -6.1502F, 3.1244F));

        PartDefinition cube_r8 = left_leg.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(26, 15).addBox(-1.5F, -3.0F, -3.3F, 3.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, 2.3502F, -0.6244F, -0.0873F, 0.0F, 0.0F));

        PartDefinition right_leg = mouserat.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(32, 34).addBox(-0.25F, 5.1502F, -6.1244F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.25F, -6.1502F, 3.1244F));

        PartDefinition cube_r9 = right_leg.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 27).addBox(-1.5F, -3.0F, -3.3F, 3.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.75F, 2.3502F, -0.6244F, -0.0873F, 0.0F, 0.0F));

        return LayerDefinition.create(meshdefinition, 64, 64);
    }

    @Override
    public void setupAnim(RatTraderEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        this.applyHeadRotation(netHeadYaw, headPitch);
        if (entity.isInWaterOrBubble()) {
            this.animate(entity.swimAnimationState, RatTraderAnimations.swim, ageInTicks, 1f);
        } else {
            this.animateWalk(RatTraderAnimations.walk, limbSwing, limbSwingAmount, 6f, 2.5f);
            this.animate(entity.idleAnimationState, RatTraderAnimations.idle, ageInTicks, 1f);
        }
    }
